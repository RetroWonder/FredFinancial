...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 3JDfbv4YbHRyxR/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: VnKrxR4J5yH_Y8/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Kv3O_J_8a2hdsW/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__z7JwP)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__wOdeq)}
                role={"img"}
              />
            ),
