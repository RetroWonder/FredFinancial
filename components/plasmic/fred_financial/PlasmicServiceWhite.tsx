...
import BlueBdr from "../../BlueBdr"; // plasmic-import: ZAq_6YLf-wrCFi/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_fred_financial.module.css"; // plasmic-import: 3EaMA65xrPs96BzDRgA4Kb/projectcss
import sty from "./PlasmicServiceWhite.module.css"; // plasmic-import: amN6ZfvGBSnRDX/css
  ...
  return (
    true ? (
      ...
      >
        ...
        <div className={classNames(projectcss.all, sty.freeBox__aei85)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <BlueBdr
                className={classNames("__wab_instance", sty.blueBdr__n8PwJ)}
              />
            ),
        ...
        <div className={classNames(projectcss.all, sty.freeBox__oo0Dx)}>
          {p.renderPlasmicSlot({
            defaultContents:
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicServiceWhite__ArgsType, ReservedPropsType> &
